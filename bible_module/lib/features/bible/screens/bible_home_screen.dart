              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  _SectionHeader(
                    ...
                    onViewMore: () => context.push(Routes.bookmarks),
                  ),
                  const SizedBox(height: 8),
                  ...
                  _SectionHeader(
                    ...
                    onViewMore: () => context.push(Routes.notes),
                  ),
                  const SizedBox(height: 8),
                  const _NotesSection(),
                  const SizedBox(height: 28),
    ...
    return settingsAsync.when(
      data: (repo) {
        ...
        return Card(
          ...
          child: InkWell(
            onTap: () => context.push('/bible/$bookId/$chapter'),
            child: Container(
        ...
        if (activePlan != null) {
          ...
          return Column(
            children: [
              ...
              OutlinedButton.icon(
                onPressed: () {
                  context.push(Routes.readingPlans);
                },
            ...
            return Column(
              children: display.map((bm) {
                ...
                return _ItemTile(
                  ...
                  onTap: () => context.push(
                    '/bible/${(bm as dynamic).bookId}/${(bm as dynamic).chapterNumber}',
                  ),
                );
              }).toList(),
            );
          ...
          children: display.map((note) {
            return _ItemTile(
              ...
              subtitle: note.content.length > 80
                  ...
                  : note.content,
              onTap: () =>
                  context.push('/bible/${note.bookId}/${note.chapterNumber}'),
            );
          }).toList(),
        );
      },
    ...
    showModalBottomSheet(
      ...
      builder: (_) => VerseSelectorSheet(
        ...
        onVerseSelected: (verseNumber) {
          context.push('/bible/${book.id}/$chapterNumber?verse=$verseNumber');
        },
      ),
    );
  }
