...
class _PrivateChatScreenState extends State<PrivateChatScreen> {
  ...
  Future<void> _uploadFile(File file, String fileType) async {
    ...
    try {
      ...
      final ref = FirebaseStorage.instance.ref('private_chats/${widget.chatId}/messages/$fileName');
  ...
  Future<void> _sendMessageData({required String message, String? fileUrl, String? fileType}) async {
    try {
      ...
      await _firestore.collection('private_chats').doc(widget.chatId).collection('messages').add({
            ...
            return Container(
              ...
              child: StreamBuilder<DocumentSnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  final name = data['name'] ?? widget.otherUserName;
