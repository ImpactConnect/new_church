      ...
      ref.listen<AsyncValue<VerseExegesis?>>(
        ...
        (_, next) {
          next.whenOrNull(
            ...
            '/exegesis/final/verse/${result.id}', extra: result);
              }
            },
          ...
          next.whenOrNull(
            data: (result) {
              if (result != null && !_hasNavigated && !_isCancelled) {
                _hasNavigated = true;
                context.pushReplacement(
            '/exegesis/final/topic/${result.id}', extra: result);
              }
            },
            error: (e, _) => _handleError(e),
          );
                    ...
                    children: List.generate(3, (i) {
                      ...
                      return Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: accent.withOpacity(opacity.toDouble()),
                          ),
                        ),
                      );
                    }),
